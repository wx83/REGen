...
class Model(nn.Module):
    ...
    def forward(self, src_txt, src_txt_mask, src_vid, src_vid_mask, src_cls=None, src_cls_mask=None):
        ...
        # use combined(txt, video) feature and pass through encoder to pred class and spans with conv projector
        ...
        #  a weighted combination of features along the sequence dimension (typically used with sequences of feature vectors)
        ...
        out["txt_mem_proj"] = txt_mem_proj # sentence-level feature
        if src_cls is not None:
...
if __name__ == "__main__":
    ...
    # Print or use the weights
    print(weight_pool_weights)
